...
uniprot_rbps <- read.delim("Databanks/uniprotkb_KW_0694_AND_model_organism_96_2025_07_04.tsv", 
...
corum <- fread("Databanks/corum_humanComplexes.txt", sep = "\t", header = TRUE) 
...
# image for download, remove # if you want to plot: 
...
### Finding the right parameters to choose the perfect cluster size - Sofia
###Goal: 
