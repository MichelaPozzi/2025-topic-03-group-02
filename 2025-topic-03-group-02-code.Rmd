...
our_proteins <- rownames(Shift_Data[Shift_Data$significant_ttest_filtered == TRUE & !is.na(Shift_Data$significant_ttest_filtered), ])

overlap <- intersect(our_proteins, known_rbps)
length(overlap)
```
