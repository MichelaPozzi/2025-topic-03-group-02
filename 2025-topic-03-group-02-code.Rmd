...
ggplot(Shift_Data, aes(x = `CoM_Ctrl`, y = `CoM_RNase`)) +
    ...
    "Novel Candidates" = "gray40",
    "Overlaping with UniProt" = "darkred",
    "UniProt Proteins not identified" = "lightcoral"
    ))+
    scale_alpha_manual(values = c("high" = 0.8, "low" = 0.2), guide = "none") +
