...
library(dplyr) # for conditional logic with case_when inside plot aesthetics <- @Cihan und Sofia: nur bei mir... kann sein, dass ihr da noch andere funktionen von nutzt 
...
# DBSCAN # its important to choose eps and minPts correctly, eps is the max distance for two points to be neighbors, minPts  minimum number of points required to form a dense region.
...
# Plot with noise in grey plots data extracted from 
