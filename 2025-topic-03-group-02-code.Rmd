...
## Addition Information about KOmlexes from CORUM_Database
```{r}
library(httr)
library(jsonlite)
...
--> Komplexe und Homodimere etc. rausstreichen bringt absolut garnix
Protein_Data_for_LR <- Protein_Data_for_LR[which(protein_data$CORUM_member == FALSE), ]
--> Next: Plot line of Maiwens Proteins and compare
```{r}
