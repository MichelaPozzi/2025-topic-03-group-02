...
GOAL: Get a feeling for the dataset and decide on necessary clean-up steps
```{r}
library(glue)
...
GOAL: Build a function to plot normalized intensity values of Ctrl and RNase across all fractions
```{r}
...
### Analyse Verbesserungen T-Test (FALSE NEGATIVE RATE)????? -Lina
...
## T-Test for non-synchronised HELA Cells (Copied and adjusted Pipeline) - Lina
```{r}
#loading Data
