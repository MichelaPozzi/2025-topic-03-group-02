...
## Validation of T-Test with UniProt Data
```{r}
library(glue)
...
###Plot Validation of T-test with UniProt Data
```{r}
library(ggplot2)
library(dplyr)
...
db <- dbscan(scaled_data, eps = 0.9, minPts = 8)
...
# View Examples
sample_RBPs_Cluster <- c("CBX8_HUMAN", "DHX8_HUMAN", "FMR1_HUMAN", "KIFC1_HUMAN", "RBM6_HUMAN", "RL27_HUMAN", "RS26L_HUMAN", "RS26_HUMAN", "RS2_HUMAN", "RS6_HUMAN", "TRI25_HUMAN", "UBF1_HUMAN", "ZCCHV_HUMAN")
