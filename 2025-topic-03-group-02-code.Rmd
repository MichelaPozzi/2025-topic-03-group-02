...
merged_filterd_mitosis <- cbind(filtered_shift_Mitosis[, c("CoM_Ctrl", "shift_distance")], filtered_peak_Mitosis[, c("n_peaks_Ctrl", "peak1_height_Ctrl", "peak2_height_Ctrl", "peak1_position_Ctrl", "peak2_position_Ctrl" )])
...
# DBSCAN
db <- dbscan(scaled_data, eps = 0.8, minPts = 7)
