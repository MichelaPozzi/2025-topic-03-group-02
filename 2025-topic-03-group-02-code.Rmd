...
```
Questions: wir sollten den DAta frame möglcihst nicht verändern!!! ... wenn man neuen Data frame will, dann neuer name
...
Questions: Hier wurde jetzt nur. RNAse-Samples betrachtet oder? 
Wäre es nicht sinnvoller, das für viele Proteine für nur eine Fraction (Ctrl ud RNAse replicates) zu machen? Ein Protein hat ja nicht so viel Aussagekraft. Und wir wollen ja am Ende eine Aussage über die Reproducibility treffen, das heist wir brauchen eine Art statistischen Test... der uns am ende sagt mit welchem Sigma unsere Aussage "Das Experiement ist wiederholbar" zutrifft. Ich denke, dass geht nur wenn wir dass für viele Proteine machen und eine Grenze festlegen, was die sd-values angeht (mit Hilfe von ChatGPT)
