...
```{r}
# Protein auswählen
protein_of_interest <- "2AAB_HUMAN" # hier dein Protein einsetzen
...
--> wir haben jetzt schon Shift länge (der Durchschnitte), es fehlt noch Shift Richtung und natürlich der RBP T-Test
```{r}
