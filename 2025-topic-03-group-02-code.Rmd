...
```{r}
# Choos Protein
protein_of_interest <- "AAAS_HUMAN" # hier dein Protein einsetzen
...
print(neg_df)
```
### Looking at specific Proteins
```{r}
# RBM10, SMN1 and FMR1 have been listed many times as RBPs (Quellen raussuchen)
proteins <- c("RBM10_HUMAN", "SMN_HUMAN", "FMR1_HUMAN")
proteins %in% rownames(MS_Table)
proteins %in% our_proteins
```
