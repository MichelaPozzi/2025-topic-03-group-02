...
## T-Test for non-synchronised HELA Cells => ich bin hier etwas verwirrt also ist das einfach unsere pipeline copiert? 
```{r}
#loading Data
...
# ok people ich bin bored also mach ich jetzt noch kmeans clustering 
```{r}
# Load your dataset (CSV or kmeans frame)
kmeans <- Shift_Data # Replace with your file or data frame


# Select 4 specific columns by name or position
# Option A: by column names

K <- kmeans[, c("CoM_Ctrl", "CoM_RNase", "shift_distance", "shift_direction")]  # Replace with column names
...
k <- 3
set.seed(42)
kmeans_result <- kmeans(K, centers = k)
