...
## Allgemeine Funktion für Shift Distance über die Peak_Means (zur Weiteren Anwendung und Anpassung für T-Test)
--> das ist zu vlt. zu einfach gedacht, siehe Bsp. ABR_HUMAN (Wie müssen vlt ich Peakamplitude mit rein nehmen, Gewichtung der Peaks)
...
```{r}
# Berechnung Average Peak Shift (wahrscheinlich nicht brauchbar)
...
# Determining position of peaks by center of mass function trough all replicates and conditions for all proteins :)
```{r}
...
results_ttest[[paste(cond, rep, sep = "_")]] <- com
}
}
...
# Add protein names as a new column:
com_MS_Table_Norm_for_t <- cbind(Protein = rownames(com_MS_Table_Norm_for_t), com_MS_Table_Norm_for_t)
